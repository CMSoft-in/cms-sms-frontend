...
class MachinesViewDetailsFour extends StatelessWidget {
  const MachinesViewDetailsFour(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
    MVCommonBasicFormFour(enabled: enabled,
    isEditing: isEditing, insuranceExpiryDateController: insuranceExpiryDateController, nextFCDateController: nextFCDateController)
      ],
    );
  }
}
